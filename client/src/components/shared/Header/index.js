                    ...
                    <div className="flex items-center justify-between py-4">
                        ...
                        <div className="hidden sm:flex sm:items-center">
                            {props.isAuthenticated ?
                                <Link to="#">Hi, {props.user.firstname}</Link>
                                :
                                <Fragment>
                                    <Link to="/auth/login" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Sign in</Link>
                                    <Link to="/auth/signup" className="text-gray-800 text-sm font-semibold border px-4 py-2 rounded-lg hover:text-purple-600 hover:border-purple-600">Sign up</Link>
                                </Fragment>
                            }
                        </div>
